class nest::app::hermes (
  ...
  Boolean                        $gitlab_mr_note_dev_enabled     = false,
  String[1]                      $gitlab_mr_note_dev_board       = 'agent-requests-dev',
  Stdlib::HTTPUrl                $gitlab_mr_note_dev_url         = 'https://gitlab-test.eyrie',
