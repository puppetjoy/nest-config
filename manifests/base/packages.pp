class nest::base::packages {
  ...
  case $facts['os']['family'] {
    'Gentoo': {
      ...
      if $facts['profile']['platform'] in ['milkv-pioneer', 'pine64', 'rock4', 'rock5', 'sopine'] {
        nest::lib::package { 'sys-fs/mtd-utils':
          ensure => installed,
        }
      }

      if $facts['profile']['platform'] in ['milkv-pioneer', 'raspberrypi5', 'rock4', 'rock5', 'strix-halo', 'wellsburg'] {
